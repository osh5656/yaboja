...
INSERT INTO USERS VALUES(USERS_SEQ.NEXTVAL,'admin','123','최강일','1','남','25','서울','네이버',1,2,3,'admin');
...
ALTER TABLE USERS
    ADD CONSTRAINT FK_USERS_USERCINEMA1_CINEMA_CI FOREIGN KEY (USERCINEMA1)
        REFERENCES CINEMA (CINEMASEQ);

ALTER TABLE USERS
    ADD CONSTRAINT FK_USERS_USERCINEMA2_CINEMA_CI FOREIGN KEY (USERCINEMA2)
        REFERENCES CINEMA (CINEMASEQ);

ALTER TABLE USERS
    ADD CONSTRAINT FK_USERS_USERCINEMA3_CINEMA_CI FOREIGN KEY (USERCINEMA3)
        REFERENCES CINEMA (CINEMASEQ);
...
INSERT INTO USERS VALUES(1,'user1','1234','유저1','유저사진','남','20대후','경기도','1',1,2,3,'일반');
INSERT INTO USERS VALUES(2,'user2','1234','유저2','유저사진2','여','20대초','경기도','1',1,2,3,'일반');
INSERT INTO USERS VALUES(3,'user3','1234','유저삼','유저사진삼','여','20대중','서울','1',1,2,3,'일반');
...
DELETE FROM coin WHERE coinlog = 500;
